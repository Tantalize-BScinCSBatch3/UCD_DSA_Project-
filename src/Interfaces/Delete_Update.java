...
public class Delete_Update extends javax.swing.JFrame {
    ...
    public Delete_Update() {
        ...
        txtSearchIsbn.setEnabled(false);
    ...
    private void tableBooksMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableBooksMouseClicked
         try {
            ...
            String sql="select * from books where ID='"+TableClick+"' ";
            PreparedStatement pst=c.prepareStatement(sql);
    ...
    public void SearchBooks(){
        try {
            ResultSet rs=null;
                  ConnectionClass connection =new ConnectionClass();
                  Connection c=connection.getConnection();
                  String val=txtSearchIsbn.getText();
                  String sql="select * from books where ISBN='"+val+"' ";
                  PreparedStatement pst=c.prepareStatement(sql);
                  rs=pst.executeQuery();
               tableBooks.setModel(DbUtils.resultSetToTableModel(rs));
        } catch (Exception ex) {
